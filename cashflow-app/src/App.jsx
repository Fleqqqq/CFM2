...
import FinancialHealthTest from './FinancialHealthTest.jsx';
...
const translations = {
    ...
    stabilityTest: 'Taloustesti',
    financialTest: {
      title: 'Yrityksen talousvakaustesti',
      subtitle: 'Vastaa 10 nopeaan kysymykseen ja näe yrityksesi taloudellinen vakaus.',
      description: 'Tämä testi arvioi yrityksesi kassavirtatilannetta, taloudellista kestävyyttä ja tärkeimpiä riskejä.',
      start: 'Aloita testi',
      next: 'Seuraava',
      back: 'Takaisin',
      questionOf: (current, total) => `Kysymys ${current} / ${total}`,
      results: {
        title: 'Taloudellinen vakaustesti',
        scoreLabel: 'Talousvakauspisteet',
        riskLabel: 'Suurin taloudellinen riski',
        impactLabel: 'Vaikutus',
        keyInsights: 'Keskeiset havainnot',
        ctaTitle: 'Paranna yrityksesi kassavirtaa',
        ctaText: 'Hanki syvällisempää tietoa, seuraa talouttasi ja valvo yrityksesi taloudellista tilaa reaaliajassa.',
        ctaButton: 'Kokeile ilmaiseksi'
      },
      risks: {
        buffer: {
          title: 'Riittämätön kassapuskuri',
          desc: 'Yritykselläsi on rajalliset kassavarat suhteessa kuukausittaisiin kuluihin. Tulojen lasku tai maksuviivästykset voivat aiheuttaa maksuvaikeuksia.'
        },
        payment: {
          title: 'Hidas maksujen kierto',
          desc: 'Asiakkaat maksavat hitaasti, mikä sitoo pääomaa ja vaikeuttaa omien laskujen maksua ajallaan.'
        },
        fixed: {
          title: 'Korkeat kiinteät kulut',
          desc: 'Suuri osa kuluistasi on kiinteitä, mikä tekee yrityksestäsi haavoittuvan myynnin laskiessa.'
        },
        debt: {
          title: 'Korkea velka-aste',
          desc: 'Lainanhoitokulut vievät merkittävän osan kassavirrasta, mikä rajoittaa liikkumavaraa ja investointikykyä.'
        },
        stable: {
          title: 'Vakaa tilanne',
          desc: 'Taloudellinen tilanteesi on vakaa. Keskity puskureiden vahvistamiseen ja kannattavaan kasvuun.'
        }
      }
    },
    ...
    tooltips: {
      ...
      costGrowth: 'Oletettu kuukausittainen kulujen kasvuprosentti.',
      taxRate: 'Arvioitu ALV- tai tuloveroprosentti joka varataan kassasta.',
    ...
    taxRate: 'Varaus veroille (%)',
    scaling: 'Skaalaus & Inflaatio',
    financialBuffers: 'Talouspuskurit',
    loanAutoDeducted: 'Vähennetään automaattisesti kuukausittaisesta kassavirrasta.',
    noLoansYet: 'Ei lainoja vielä — lisää ne klikkaamalla Muokkaa.',
    growthFlat: '0% — Tasainen',
    growthRapid: '20% — Nopea',
    financialHealth: 'Taloudellinen terveys',
    netPerMonth: 'Netto / kk',
    margin: 'Marginaali',
    runway: 'Kassareitti',
    runwayMonths: (n) => `${n} kk`,
    criticalWarning: (n) => `Kriittinen: Kassa loppuu ${n} ${n === 1 ? 'kuukauden' : 'kuukauden'} kuluttua. Leikkaa kuluja tai kasvata tuloja.`,
    profitableMsg: (amount) => `Kannattava. Kasvu ${amount}/kk.`,
    costGrowthHint: 'Ennustaa nousevat kulut (inflaatio tai skaalautuvat menot).',
    taxHint: 'Arvioi ALV tai tulovero varattavaksi kassavirrasta.',
    confirmReset: 'Haluatko varmasti nollata kaikki syötteet?',
    confirmResetTitle: 'Nollaa syötteet',
    yesReset: 'Kyllä, nollaa',
    ...
    welcome: {
      ...
      guide: {
        title: 'FAQ',
        whatIs: {
          title: 'Mitä on kassavirta?',
          desc: 'Kassavirta on yritykseen tulevan ja sieltä lähtevän rahan nettomäärä tietyllä ajanjaksolla. Se on yrityksen elämänlanka.'
        },
        whyMatters: {
          title: 'Miksi kassavirran hallinta on tärkeää?',
          desc: 'Oikea hallinta varmistaa, että voit maksaa työntekijöillesi, toimittajillesi ja verosi ajallaan, samalla kun tunnistat kasvumahdollisuudet.'
        },
        forecasting: {
          title: 'Kassavirtaennuste',
          desc: 'Ennustaminen sisältää tulevan myynnin ja kulujen arvioinnin yrityksesi tulevan taloudellisen aseman ennustamiseksi.'
        },
        tools: {
          title: 'Työkalut kassavirran hallintaan',
          desc: 'Manuaalisista taulukoista Rahanton kaltaisiin edistyneisiin ohjelmistoihin – oikeat työkalut yksinkertaistavat seurantaa ja tarjoavat reaaliaikaista tietoa.'
        },
        mistakes: {
          title: 'Yleisimmät kassavirtavirheet',
          desc: 'Suunnittelun puute sesonkiluonteisille vaihteluille, pienten kulujen huomioimatta jättäminen ja liiallinen luototus ovat yleisiä sudenkuoppia.'
        }
      }
    },
    checkIn: {
      title: 'Päivittäinen kirjaus',
      done: 'Kirjattu!',
      question: (amount) => `Onko nykyinen kassasi edelleen ${amount}?`,
      yes: 'Kyllä on',
      update: 'Päivitä kassa',
      insightTitle: 'Päivän vinkki',
      insights: [
        'Maksetaanko jokin lasku tällä viikolla? Merkitse se kalenteriin jo tänään, jotta kassa ei yllätä.',
        'Tarkista, onko sinulla laskuja, joita asiakkaat eivät ole vielä maksaneet. Maksumuistutus lähetettynä ajoissa parantaa kassavirtaa merkittävästi.',
        'Laske tämän kuun kiinteät kulusi. Jos ne ylittävät 50 % liikevaihdostasi, on aika miettiä, mitkä voit leikata.',
        'Onko sinulla hidas kuukausi tulossa? Harkitse ennakkolaskua tai kertamaksua, joka tuo kassaan rahaa nyt.',
        'Muista, että ALV-maksut voivat olla suuria ja yllättäviä. Laita sivuun noin 25 % jokaisesta tulosta.',
        'Asiakkaiden maksuajat vaikuttavat suoraan kassaasi. Lyhyemmät maksuajat = parempi kassavirta.',
        'Oletko tarkistanut viime kuussa, mihin rahaa oikeasti meni? Yksi kuitti kerrallaan selviää totuus.',
        'Mieti, voitko nostaa hintojasi 5–10 %. Pienikin hinnankorotus kasvattaa katetta huomattavasti.',
        'Jos sinulla on lainaa, varmista, että kuukausierä on alle 20 % liikevaihdosta — muuten se rasittaa kassaa liikaa.',
        'Onko jokin kulusi kasvanut huomaamatta? Vertaa tämän kuukauden kuluja 3 kuukauden takaisiin.'
      ]
    },
  ...
  en: {
    ...
    financialTest: {
      title: 'Business Financial Stability Test',
      subtitle: 'Answer 10 quick questions and see how financially stable your business is.',
      description: 'This test evaluates your company’s cash flow situation, financial durability, and the main risks affecting your business.',
      start: 'Start the Test',
      next: 'Next',
      back: 'Back',
      questionOf: (current, total) => `Question ${current} of ${total}`,
      results: {
        title: 'Financial Stability Results',
        scoreLabel: 'Financial Stability Score',
        riskLabel: 'Largest Financial Risk',
        impactLabel: 'Impact',
        keyInsights: 'Key Observations',
        ctaTitle: 'Improve Your Business Cash Flow',
        ctaText: 'Get deeper insights, track your finances, and monitor your company’s financial stability in real time.',
        ctaButton: 'Try for Free'
      },
      risks: {
        buffer: {
          title: 'Insufficient Cash Buffer',
          desc: 'Your business currently has limited cash reserves compared to its monthly expenses. This means a drop in revenue or delayed customer payments could create cash flow pressure.'
        },
        payment: {
          title: 'Slow Payment Cycle',
          desc: 'Customers are paying slowly, which ties up capital and makes it harder to pay your own bills on time.'
        },
        fixed: {
          title: 'High Fixed Costs',
          desc: 'A large portion of your expenses are fixed, making your business vulnerable to fluctuations in sales.'
        },
        debt: {
          title: 'High Debt Burden',
          desc: 'Loan repayments consume a significant part of your cash flow, limiting your flexibility and ability to invest.'
        },
        stable: {
          title: 'Stable Position',
          desc: 'Your financial position is stable. Focus on strengthening buffers and profitable growth.'
        }
      }
    },
    ...
    tooltips: {
      ...
      costGrowth: 'Assumed monthly percentage growth in costs (inflation, wage rises).',
      taxRate: 'Percentage of revenue to set aside for VAT or income tax.',
    ...
    taxRate: 'Tax Reserve (%)',
    scaling: 'Scaling & Inflation',
    financialBuffers: 'Financial Buffers',
    loanAutoDeducted: 'Automatically deducted from your monthly cash flow.',
    noLoansYet: 'No loans yet — click Edit to add one.',
    growthFlat: '0% — Flat',
    growthRapid: '20% — Rapid',
    financialHealth: 'Financial Health',
    netPerMonth: 'Net / mo',
    margin: 'Margin',
    runway: 'Runway',
    runwayMonths: (n) => `${n} mo`,
    criticalWarning: (n) => `Critical: Cash runs out in ${n} ${n === 1 ? 'month' : 'months'}. Cut costs or increase revenue now.`,
    profitableMsg: (amount) => `Profitable. Growing by ${amount}/mo.`,
    costGrowthHint: 'Predicts rising costs (inflation or scaling expenses).',
    taxHint: 'Estimate VAT or income tax to set aside for reliable cash forecasting.',
    confirmReset: 'Are you sure you want to reset all inputs?',
    confirmResetTitle: 'Reset Inputs',
    yesReset: 'Yes, reset',
    ...
    welcome: {
      ...
      guide: {
        title: 'FAQ',
        whatIs: {
          title: 'What is Cashflow?',
          desc: 'Cash flow is the net amount of cash and cash-equivalents being transferred into and out of a business. It is the lifeblood of your company.'
        },
        whyMatters: {
          title: 'Why Cashflow Management Matters?',
          desc: 'Proper management ensures that a business can pay its employees, vendors, and taxes on time while identifying growth opportunities.'
        },
        forecasting: {
          title: 'Cashflow Forecasting',
          desc: 'Forecasting involves estimating future sales and expenses to predict your business\'s future financial position.'
        },
        tools: {
          title: 'Tools for Managing Cashflow',
          desc: 'From manual spreadsheets to advanced software like Rahanto, the right tools simplify complex tracking and provide real-time insights.'
        },
        mistakes: {
          title: 'Common Cashflow Mistakes',
          desc: 'Failing to plan for seasonal dips, ignoring small expenses, and overextending credit are common pitfalls that can sink a business.'
        }
      }
    },
    checkIn: {
      ...
      question: (amount) => `Is your current cash balance still ${amount}?`,
      yes: 'Yes, it is',
      update: 'Update balance',
      insightTitle: 'Daily Insight',
      insights: [
        'Do you have any invoices due this week? Add them to your calendar now so your cash balance doesn\'t catch you off guard.',
        'Check if any customers have unpaid invoices. A polite reminder sent today can bring cash in faster than you think.',
        'Add up your fixed costs this month. If they exceed 50% of your revenue, it\'s time to find at least one to cut.',
        'Expecting a slow month ahead? Consider sending a prepayment invoice or an early-bird offer to bring cash forward.',
        'VAT payments can be large and sudden. Set aside ~25% of each income payment as you receive it — don\'t wait.',
        'Your clients\' payment terms directly affect your cash flow. Shorter terms = healthier cash position.',
        'Reviewed last month\'s spending? Go through your receipts once a week — the truth about waste is always in the details.',
        'Could you raise your prices by 5–10%? Even a small increase has an outsized effect on your profit margin.',
        'If you have a loan, make sure the monthly payment is under 20% of your revenue — otherwise it\'s putting real strain on your cash.',
        'Has any recurring cost crept up without you noticing? Compare this month\'s expenses to 3 months ago.'
      ]
    },
...
const globalStyles = `
    ...
    html, body { min-height: 100vh !important; background-color: var(--app-bg) !important; margin: 0; padding: 0; }
    .app-container { min-height: 100vh; background-color: var(--app-bg); color: var(--text-primary); position: relative; }
    ...
    .modal-backdrop.darken-everything { position: fixed !important; top: -100% !important; left: -100% !important; bottom: -100% !important; right: -100% !important; width: 300% !important; height: 300% !important; background-color: rgba(0,0,0,0.6) !important; z-index: 9998 !important; pointer-events: auto; }
    .modal.show-everything { z-index: 9999 !important; }
    ...
    .timeline-container {
      ...
      width: 300px; /* Fixed width for consistent stretchy math */
    }
    ...
    .timeline-slider-backdrop {
      ...
      /* This transition creates the "stretch" effect */
      transition: left 0.5s cubic-bezier(0.34, 1.56, 0.64, 1), 
                  right 0.5s cubic-bezier(0.34, 1.56, 0.64, 1);
    }

    /* Stretchy behavior: when moving right, the right side leads */
    .timeline-container[data-dir="forward"] .timeline-slider-backdrop {
      transition: left 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275) 0.1s, 
                  right 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275);
    }

    /* When moving left, the left side leads */
    .timeline-container[data-dir="backward"] .timeline-slider-backdrop {
      transition: left 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275), 
                  right 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275) 0.1s;
    }
...
function App() {
  // Prevent browser from restoring scroll position automatically which causes jumps
  useEffect(() => {
  ...
  const [costGrowth, setCostGrowth] = useState(0);
  ...
  const [prevTimelineIndex, setPrevTimelineIndex] = useState(4); // Default to '1y' index
  ...
  const [stabilityTestData, setStabilityTestData] = useState(null);
  ...
  const [lastCheckInDate, setLastCheckInDate] = useState(() => {
    try {
      return localStorage.getItem(`lastCheckIn_${user?.email}`) || null;
    } catch { return null; }
  });
  ...
  // Global scroll to top on page changes to prevent glitches
  // Use useLayoutEffect to ensure this happens before the browser paints
  useLayoutEffect(() => {
    window.scrollTo(0, 0);
  ...
  useEffect(() => {
    if (user && isInitialized) {
      ...
      const last = localStorage.getItem(`lastCheckIn_${user.email}`);
      if (last !== today) {
  ...
  const handleCheckIn = () => {
    ...
    localStorage.setItem(`lastCheckIn_${user.email}`, today);
  ...
  useEffect(() => {
    if (activeProject) {
      ...
      setCostGrowth(activeProject.costGrowth || 0);
  ...
  }, [cashBalance, monthlyRevenue, fixedCosts, variableCosts, revenueGrowth, costGrowth, units, unitPrice, unitCost, oneTimeRevenue, oneTimeCost, inputMode]);
  ...
  }, [location.pathname, isInitialized, projectsLoaded, projects, user, showProjectManager, isCreatingNewProject, navigate]);
  ...
  const handleStabilityTestComplete = async (answers, score) => {
    console.log('Stability test complete! Attempting to save lead data...', { answers, score });
    setStabilityTestData({ answers, score });
    ...
    try {
      ...
      if (error) {
        ...
        console.log('Lead data saved successfully to Supabase:', data);
      }
    } catch (err) {
      console.error('Unexpected error during lead collection:', err);
    }
  ...
  const updateProject = (updated) => {
    ...
    setCostGrowth(updated.costGrowth || 0);
    setTaxRate(updated.taxRate || 0);
  ...
  useEffect(() => {
    ...
    switch (timeline) {
      case '7d': iterations = 7; revenueFactor = 1 / 30; growthDivisor = 30; break;
      case '1m': iterations = 30; revenueFactor = 1 / 30; growthDivisor = 30; break;
      case '3m': iterations = 12; revenueFactor = 1 / 4.33; growthDivisor = 4.33; break;
      case '6m': iterations = 6; break;
      case '1y': default: iterations = 12; break;
    }

    for (let i = 0; i < iterations; i++) {
      const revenueThisStep = monthlyRevenue * revenueFactor * Math.pow((1 + revenueGrowth / 100), i / growthDivisor);
      const expenseScale = Math.pow((1 + costGrowth / 100), i / growthDivisor);

      let expensesThisStep = (fixedCosts * revenueFactor * expenseScale) + (revenueThisStep * variableCostsPercentage);
      let profitThisStep = revenueThisStep - expensesThisStep - (loanInfo.totalPayment * revenueFactor);

      // Apply tax deduction as a cash flow buffer
      if (taxRate > 0) {
        profitThisStep -= (revenueThisStep * (taxRate / 100));
      }

      // Store recurring profit
      profitProjection.push(profitThisStep / revenueFactor);

      // Add one-time events only in the first month
      if (i === 0) {
        profitThisStep += (oneTimeRevenue || 0);
        profitThisStep -= (oneTimeCost || 0);
      }

      currentCash += profitThisStep;
      projection.push(currentCash);
      revenueProjection.push(revenueThisStep / revenueFactor);
    }

    setForecastData({ projection, revenueProjection, profitProjection, breakEven });
  }, [cashBalance, monthlyRevenue, fixedCosts, variableCosts, revenueGrowth, costGrowth, taxRate, oneTimeRevenue, oneTimeCost, timeline, loanInfo.totalPayment]);
    ...
    datasets: [
      {
        ...
        backgroundColor: (context) => {
          ...
          if (scales && scales.y) {
            ...
            zeroStop = (bottom - zeroPixel) / (bottom - top);
            zeroStop = Math.max(0, Math.min(1, zeroStop));
          }

          const gradient = ctx.createLinearGradient(0, chartArea.bottom, 0, chartArea.top);
          gradient.addColorStop(0, 'rgba(239, 68, 68, 0.25)'); // Red bottom
          gradient.addColorStop(zeroStop, 'rgba(239, 68, 68, 0.05)'); // Red fade
          gradient.addColorStop(zeroStop, 'rgba(16, 185, 129, 0.05)'); // Green fade
          gradient.addColorStop(1, 'rgba(16, 185, 129, 0.25)'); // Green top
          return gradient;
        },
        borderWidth: 3,
        tension: 0.4, // Fluid, stretchy line
      ...
      },
      {
        ...
        data: forecastData.profitProjection,
        borderColor: '#94a3b8', // Slate 400
        segment: {
          borderColor: ctx => (ctx.p0.parsed.y < 0 || ctx.p1.parsed.y < 0) ? '#ef4444' : '#94a3b8',
        },
  ...
  const chartOptions = useMemo(() => ({
    ...
    animation: {
      duration: 1250,
      easing: 'easeOutBack', // Bouncy/stretchy feeling
    },
    plugins: {
      legend: {
        display: false,
  ...
  // --- Personalised daily insight ---
  const getPersonalizedInsight = () => {
    const fmt = (n) => new Intl.NumberFormat(language === 'fi' ? 'fi-FI' : 'en-US', { style: 'currency', currency: 'EUR', maximumFractionDigits: 0 }).format(n);
    const loanMonthly = (activeProject?.loans || []).reduce((sum, l) => sum + (parseFloat(l.monthlyPayment) || 0), 0);
    const totalCosts = (fixedCosts || 0) + (variableCosts || 0) + loanMonthly;
    const monthlyCashflow = (monthlyRevenue || 0) - totalCosts;
    const isFi = language === 'fi';

    if (!monthlyRevenue || monthlyRevenue === 0) {
      return isFi
        ? 'Syötä kuukausittainen liikevaihto nähdäksesi henkilökohtaisen kassavirtaennusteen.'
        : 'Enter your monthly revenue to unlock a personalized cash-flow forecast for this project.';
    }
    if (monthlyCashflow < 0 && cashBalance > 0) {
      const runway = Math.floor(cashBalance / Math.abs(monthlyCashflow));
      return isFi
        ? `Kulusi ylittävät tulot ${fmt(Math.abs(monthlyCashflow))} / kk. Nykyisellä kassalla (${fmt(cashBalance)}) sinulla on rahaa ${runway} kuukautta — ryhdy toimeen nyt.`
        : `Costs exceed income by ${fmt(Math.abs(monthlyCashflow))} / mo. Your cash of ${fmt(cashBalance)} will last roughly ${runway} more month${runway !== 1 ? 's' : ''} — act now.`;
    }
    if (monthlyCashflow < 0 && Math.abs(monthlyCashflow) < monthlyRevenue * 0.15) {
      return isFi
        ? `Olet lähellä nollatulosta — tarvitset vain ${fmt(Math.abs(monthlyCashflow))} / kk lisää liikevaihtoa tai vastaavan kululeikkauksen.`
        : `You're close to break-even — just ${fmt(Math.abs(monthlyCashflow))} / mo more revenue or equivalent cost savings puts you in profit.`;
    }
    if (monthlyRevenue > 0 && fixedCosts / monthlyRevenue > 0.5) {
      const pct = Math.round((fixedCosts / monthlyRevenue) * 100);
      return isFi
        ? `Kiinteät kulusi ovat ${pct} % liikevaihdostasi (${fmt(fixedCosts)} / kk). Korkea — pienikin myynnin lasku voi viedä sinut tappiolle.`
        : `Fixed costs are ${pct}% of revenue (${fmt(fixedCosts)} / mo). That's high — even a small dip in sales could push you into the red.`;
    }
    if (monthlyCashflow > 0 && cashBalance < totalCosts * 2) {
      return isFi
        ? `Kassavirtasi on positiivinen (${fmt(monthlyCashflow)} / kk), mutta kassapuskurisi (${fmt(cashBalance)}) kattaa alle 2 kuukautta kuluja. Pyri 3 kuukauden puskuriin.`
        : `Cash flow is positive (${fmt(monthlyCashflow)} / mo), but your buffer (${fmt(cashBalance)}) covers under 2 months of costs. Aim for 3 months as a safety net.`;
    }
    if (monthlyCashflow > 0 && cashBalance >= totalCosts * 3) {
      return isFi
        ? `Erinomainen tilanne! Kassasi (${fmt(cashBalance)}) kattaa yli 3 kuukautta kuluja ja kassavirta on ${fmt(monthlyCashflow)} / kk positiivinen.`
        : `Strong position! Cash (${fmt(cashBalance)}) covers 3+ months of costs and flow is ${fmt(monthlyCashflow)} / mo. Consider investing the surplus in growth.`;
    }
    return isFi
      ? `Kassasi on ${fmt(cashBalance)} ja kuukausikate on ${fmt(monthlyCashflow)}.`
      : `Cash stands at ${fmt(cashBalance)} with a monthly net of ${fmt(monthlyCashflow)}.`;
  };
  ...
  const deleteAccountModalContent = accountToDelete ? (
    <>
      <div className="modal-backdrop darken-everything fade show"></div>
      <div className="modal show-everything fade show d-block" tabIndex="-1" role="dialog">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button type="button" className="btn btn-secondary" onClick={() => setAccountToDelete(null)} disabled={isDeletingAccount}>{t.cancel}</button>
              <button type="button" className="btn btn-danger" onClick={handleDeleteAccount} disabled={isDeletingAccount}>
                {isDeletingAccount ? (
                  <><span className="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>{t.deleteAccount}...</>
                ) : t.deleteAccount}
              </button>
            </div>
          </div>
  ...
  if (activePage === 'cookie-policy') {
    pageContent = <CookiePolicy t={t} theme={theme} onBack={() => setActivePage('welcome')} />;
  } else if (activePage === 'privacy-policy') {
    pageContent = <PrivacyPolicy t={t} theme={theme} onBack={() => setActivePage('welcome')} />;
  } else if (activePage === 'patch-notes') {
    pageContent = <PatchNotes t={t} theme={theme} onBack={() => setActivePage('welcome')} />;
  } else if (activePage === 'financial-stability-test') {
    pageContent = (
      <>
        <nav className="navbar navbar-expand-lg navbar-light border-bottom sticky-top py-3" style={{ background: 'var(--surface-bg)' }}>
          <div className="container-lg d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center gap-2" style={{ cursor: 'pointer' }} onClick={() => setActivePage('welcome')}>
              <span className="fw-bold h5 mb-0" style={{ letterSpacing: '-0.5px' }}>Rahanto</span>
            </div>
            <button className="btn btn-sm btn-white border rounded-pill d-flex align-items-center gap-2" onClick={() => setActivePage('welcome')}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
              {t.back}
            </button>
          </div>
        </nav>
        <FinancialHealthTest t={t} theme={theme} onStartFreeManual={handleStabilityTestComplete} />
      </>
    );
  } else if (location.pathname === '/settings' && user) {
    pageContent = <ProfileSettings user={user} onUpdateUser={handleUpdateUser} onClose={() => navigate('/')} onDeleteAccount={setAccountToDelete} t={t} />;
  } else if (showSupport && user) {
    pageContent = <Support user={user} onClose={() => setShowSupport(false)} t={t} />;
    ...
    pageContent = (
      <>
              ...
              <div className="profile-dropdown-container">
                ...
                {showProfileDropdown && (
                  <div className="profile-dropdown card border-0 shadow-lg fade-scale">
                    ...
                    <button className="dropdown-item" onClick={() => { navigate('/submissions'); setShowProfileDropdown(false); }}>Stability Results</button>
        ...
        <main className="mx-auto" style={{ maxWidth: '1200px', padding: '4rem 2rem', minHeight: 'calc(100vh - 150px)' }}>
          <div className="text-center mb-5 fade-scale">
            <span className="badge bg-primary-subtle text-primary px-3 py-2 rounded-pill mb-3 fw-bold" style={{ letterSpacing: '1px' }}>DASHBOARD</span>
            <h1 className="display-4 fw-bold mb-3">{t.yourProjects}</h1>
            <p className="lead text-secondary mx-auto" style={{ maxWidth: '600px' }}>
              Manage your businesses, view cashflows, and forecast future revenue all in one place.
            </p>
          </div>
          
          {isLoadingProjects && (
            <div className="text-center my-5 fade-scale">
          ...
          <div className="project-grid">
            {projects.map((p, index) => (
              <div key={p.id} className={`project-card fade-scale ${activeProjectId === p.id ? 'active' : ''}`} style={{ animationDelay: `${index * 0.1}s`, minHeight: '220px' }} onClick={() => {
                navigate(`/projects/${encodeURIComponent(p.name)}`);
              }}>
                <button className="btn-delete-project shadow-sm" title={`${t.deleteProject} ${p.name}`} onClick={(e) => {
                ...
                <div className="d-flex align-items-center mb-4">
                  <div className="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center fw-bold me-3 shadow-sm" style={{ width: '56px', height: '56px', fontSize: '1.5rem' }}>
                    {p.name.charAt(0).toUpperCase()}
                  </div>
                  <div className="overflow-hidden">
                    <h3 className="h5 fw-bold mb-1 text-truncate" title={p.name}>{p.name}</h3>
                ...
                <div className="mt-auto pt-3 border-top d-flex justify-content-between align-items-center" style={{ borderColor: 'var(--border-color)' }}>
                  <span className="text-primary fw-bold d-flex align-items-center gap-2" style={{ fontSize: '0.9rem' }}>
                    Open Dashboard
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ transition: 'transform 0.2s' }} className="project-arrow"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                  </span>
                </div>
              </div>
            ))}
            ...
            {(!user?.isPremium && projects.length >= 1) ? (
              <div
                className="project-card new-project fade-scale d-flex flex-column align-items-center justify-content-center text-center p-4"
                style={{
                  cursor: 'pointer',
                  ...
                  opacity: 1,
                  minHeight: '220px',
                  animationDelay: `${projects.length * 0.1}s`
                }}
                onClick={() => setShowUpgradeModal(true)}
                title={t.upgradeToCreateMore}
              >
                <div className="mb-3 d-flex align-items-center justify-content-center rounded-circle bg-warning-subtle text-warning shadow-sm" style={{ width: '56px', height: '56px' }}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                </div>
                <h6 className="fw-bold mb-2">{t.welcome.premiumFeature2}</h6>
                <p className="text-secondary small mb-3">Upgrade to manage unlimited startups.</p>
              ...
              <div 
                className="project-card new-project fade-scale text-center d-flex flex-column align-items-center justify-content-center p-4" 
                style={{ minHeight: '220px', borderStyle: 'dashed', borderWidth: '2px', animationDelay: `${projects.length * 0.1}s` }} 
                onClick={handleNewProject}
              >
                <div className="rounded-circle bg-primary-subtle text-primary d-flex align-items-center justify-content-center mb-3 transition-transform shadow-sm" style={{ width: '56px', height: '56px' }}>
                ...
                <span className="fw-bold h5 text-primary mb-1">{t.newProject}</span>
                <p className="text-secondary small mb-0">Start projecting a new business</p>
              </div>
            )}
          </div>
    ...
    pageContent = <Overview project={activeProject} onUpdateProject={updateProject} onContinue={() => setShowOverview(false)} onHome={handleGoHome} t={t} />;
  } else {
    pageContent = (
      <>
        ...
        {isResetConfirming && (
          <div className="modal fade show d-block" tabIndex="-1" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
            <div className="modal-dialog modal-dialog-centered">
              <div className={`modal-content border-0 shadow-lg ${theme === 'dark' ? 'bg-dark text-white' : ''}`}>
                <div className="modal-header border-0 pb-0">
                  <h5 className="modal-title fw-bold">{t.confirmResetTitle}</h5>
                  <button type="button" className={`btn-close ${theme === 'dark' ? 'btn-close-white' : ''}`} onClick={() => setIsResetConfirming(false)}></button>
                </div>
                <div className="modal-body">
                  <p className="mb-0 text-muted">{t.confirmReset}</p>
                </div>
                <div className="modal-footer border-0 pt-0">
                  <button type="button" className="btn btn-outline-secondary" onClick={() => setIsResetConfirming(false)}>{t.cancel}</button>
                  <button type="button" className="btn btn-danger text-white fw-bold" onClick={() => { handleResetInputs(); setIsResetConfirming(false); }}>{t.yesReset}</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <main className="p-4 mx-auto" style={{ maxWidth: '1600px' }}>
        <div className="app-wrapper">
          <aside className="sidebar">
            <a href="#" className={`nav-item-custom d-flex justify-content-between align-items-center ${activeView === 'dashboard' ? 'active' : ''}`} onClick={(e) => { e.preventDefault(); navigate('/'); }}>
              <span>{t.predictionTab}</span>
            </a>
          ...
          <div className="main-content">
            <Routes>
              <Route path="/" element={
                <>
                  {user && showCheckInBanner && (
                    <div className="card border-0 shadow-sm mb-4 theme-card overflow-hidden fade-scale" style={{
                      backgroundColor: 'var(--surface-bg)',
                      ...
                      <div className="card-body p-4">
                        <div className="d-flex align-items-center gap-2 mb-2">
                          <div className="d-flex align-items-center justify-content-center bg-success-subtle text-success rounded" style={{ width: '28px', height: '28px', border: '1px solid rgba(22, 163, 74, 0.2)' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                              <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" />
                            </svg>
                          </div>
                          <h5 className="fw-bold mb-0" style={{ color: 'var(--text-primary)' }}>{t.checkIn?.title}</h5>
                        </div>

                        <p className="mb-3 fs-5" style={{ color: 'var(--text-secondary)' }}>
                          {t.checkIn?.question(new Intl.NumberFormat(language === 'fi' ? 'fi-FI' : 'en-US', { style: 'currency', currency: 'EUR' }).format(cashBalance))}
                        </p>

                        <div className="d-flex align-items-center gap-3 mb-4">
                          <button className="btn btn-primary rounded-3 px-4 fw-bold shadow-sm" onClick={handleCheckIn}>
                            {t.checkIn?.yes}
                          </button>
                          <button className="btn btn-light rounded-3 px-4 fw-medium border shadow-sm" onClick={() => {
                            const el = document.getElementById('easy-cash') || document.getElementById('advanced-cash');
                            if (el) el.focus();
                            setShowCheckInBanner(false);
                          }}>
                            {t.checkIn?.update}
                        ...
                        <div className="p-3 rounded-3" style={{ backgroundColor: 'var(--highlight-bg)', border: '1px solid var(--border-color)' }}>
                          <div className="d-flex align-items-center gap-2 mb-2">
                            ...
                            <span className="small fw-bold text-uppercase" style={{ letterSpacing: '0.05em', color: 'var(--text-secondary)' }}>{t.checkIn?.insightTitle}</span>
                          </div>
                    ...
                    <div className="card border-0 shadow-sm h-100">
                      <div className="card-body p-3">
                        <div className="d-flex justify-content-between align-items-center mb-4">
                          ...
                          <button className="btn btn-sm btn-outline-secondary d-flex align-items-center gap-1" onClick={() => setIsResetConfirming(true)}>
                          ...
                          <div className="p-1 fade-scale">
                            <div className="d-flex flex-column gap-4">
                              ...
                              <div className="p-3 rounded d-flex flex-column gap-3" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                <div>
                                  <label htmlFor="easy-revenue" className="form-label small text-muted fw-bold">
                                    {t.monthlyIncome}
                                    <InfoTooltip text={t.tooltips?.monthlyRevenue} />
                                  </label>
                                  <div className="input-group">
                                    <span className="input-group-text border-end-0 text-muted">€</span>
                                    <input type="text" className={`form-control border-start-0 ps-1 ${highlightMonthlyRevenue ? 'input-highlight-flash' : ''}`} id="easy-revenue" placeholder="0" value={formatForInput(monthlyRevenue)} onChange={(e) => {
                              ...
                              {/* Loan payments */}
                              <div>
                                <label className="form-label small text-muted fw-bold">{t.loanPayment}</label>
                                <div className="input-group">
                                  <span className="input-group-text border-end-0 text-muted">€</span>
                                  <input type="text" className="form-control border-start-0 ps-1" style={{ backgroundColor: 'var(--highlight-bg)' }} value={formatForInput(loanInfo.totalPayment)} readOnly />
                                  <button className="btn btn-outline-secondary" type="button" onClick={() => navigate('/assets')}>{t.edit}</button>
                                </div>
                                <div className="form-text small text-muted mt-1" style={{ fontSize: '0.7rem' }}>
                                  {loanInfo.totalPayment > 0 ? t.loanAutoDeducted : t.noLoansYet}
                                </div>
                              </div>
                              ...
                              <div>
                                <label className="form-label small text-muted fw-bold d-flex justify-content-between align-items-center">
                                  ...
                                  <span className="fw-bold" style={{ color: revenueGrowth > 0 ? '#10b981' : 'var(--text-secondary)' }}>{revenueGrowth}% / mo</span>
                                </label>
                                <input
                                  type="range"
                                ...
                                />
                                <div className="d-flex justify-content-between" style={{ fontSize: '0.68rem', color: 'var(--text-secondary)' }}>
                                  <span>{t.growthFlat}</span>
                                  <span>{t.growthRapid}</span>
                                </div>
                              </div>

                              {/* Live Financial Health Strip */}
                              {(() => {
                                const loanM = loanInfo.totalPayment || 0;
                                const totalCosts = fixedCosts + variableCosts + loanM;
                                const net = monthlyRevenue - totalCosts;
                                const grossMargin = monthlyRevenue > 0 ? (((monthlyRevenue - variableCosts) / monthlyRevenue) * 100).toFixed(1) : null;
                                const runway = net < 0 && cashBalance > 0 ? Math.floor(cashBalance / Math.abs(net)) : null;
                                const marginColor = grossMargin !== null
                                  ? (parseFloat(grossMargin) > 40 ? '#10b981' : parseFloat(grossMargin) > 15 ? '#f59e0b' : '#ef4444')
                                  : 'var(--text-secondary)';
                                return (
                                  <div className="rounded p-3" style={{ border: '1px solid var(--border-color)', backgroundColor: 'var(--surface-bg)' }}>
                                    <p className="mb-3 fw-bold text-uppercase" style={{ fontSize: '0.68rem', letterSpacing: '1px', color: 'var(--text-secondary)' }}>{t.financialHealth}</p>
                                    <div className="row g-0 text-center">
                                      <div className="col-4">
                                        <div className="text-muted mb-1" style={{ fontSize: '0.62rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>{t.netPerMonth}</div>
                                        <div className={`fw-bold ${net >= 0 ? 'text-success' : 'text-danger'}`} style={{ fontSize: '0.95rem' }}>
                                          {net >= 0 ? '+' : ''}{new Intl.NumberFormat(language === 'fi' ? 'fi-FI' : 'en-US', { style: 'currency', currency: 'EUR', maximumFractionDigits: 0 }).format(net)}
                                        </div>
                                      </div>
                                      <div className="col-4 border-start border-end" style={{ borderColor: 'var(--border-color)' }}>
                                        <div className="text-muted mb-1" style={{ fontSize: '0.62rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>{t.margin}</div>
                                        <div className="fw-bold" style={{ fontSize: '0.95rem', color: marginColor }}>
                                          {grossMargin !== null ? `${grossMargin}%` : '—'}
                                        </div>
                                      </div>
                                      <div className="col-4">
                                        <div className="text-muted mb-1" style={{ fontSize: '0.62rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>{t.runway}</div>
                                        <div className={`fw-bold ${net >= 0 ? 'text-success' : runway !== null && runway <= 3 ? 'text-danger' : runway !== null && runway <= 6 ? 'text-warning' : ''}`} style={{ fontSize: '0.95rem' }}>
                                          {net >= 0 ? '∞' : runway !== null ? t.runwayMonths(runway) : '—'}
                                        </div>
                                      </div>
                                    </div>
                                    {net < 0 && runway !== null && runway <= 3 && (
                                      <div className="mt-3 p-2 rounded text-danger" style={{ backgroundColor: 'rgba(239,68,68,0.06)', border: '1px solid rgba(239,68,68,0.2)', fontSize: '0.78rem' }}>
                                        {t.criticalWarning(runway)}
                                      </div>
                                    )}
                                    {net >= 0 && monthlyRevenue > 0 && (
                                      <div className="mt-3 p-2 rounded text-success" style={{ backgroundColor: 'rgba(16,185,129,0.06)', border: '1px solid rgba(16,185,129,0.2)', fontSize: '0.78rem' }}>
                                        {t.profitableMsg(new Intl.NumberFormat(language === 'fi' ? 'fi-FI' : 'en-US', { style: 'currency', currency: 'EUR', maximumFractionDigits: 0 }).format(net))}
                                      </div>
                                    )}
                                  </div>
                                );
                          ...
                          <div className="p-1 fade-scale">
                            <div className="d-flex flex-column gap-4">
                              ...
                              <div>
                                ...
                                <div className="p-3 rounded d-flex flex-column gap-3" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                  <div>
                                    <label className="form-label small text-muted fw-bold">{t.monthlyRevenue}</label>
                                    <div className="input-group">
                                      <span className="input-group-text border-end-0 text-muted">€</span>
                                      <input type="text" className="form-control border-start-0 ps-1" value={formatForInput(monthlyRevenue)} onChange={(e) => setMonthlyRevenue(parseFromInput(e.target.value))} />
                                    </div>
                                  </div>
                                  <div>
                                    <label className="form-label small text-muted fw-bold">{t.revenueGrowth}</label>
                                    <div className="input-group">
                                      <input type="number" className="form-control border-end-0" value={revenueGrowth || ''} onChange={(e) => setRevenueGrowth(parseFloat(e.target.value) || 0)} />
                                      <span className="input-group-text border-start-0 text-muted">%</span>
                                    </div>
                                  </div>
                                </div>
                              </div>

                              {/* Section: Expenses & Inflation */}
                              <div>
                                <h6 className="text-uppercase text-secondary fw-bold" style={{ fontSize: '0.75rem', letterSpacing: '1px' }}>{t.recurringCosts}</h6>
                                <div className="p-3 rounded d-flex flex-column gap-3" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                  <div className="row g-2">
                                    <div className="col-6">
                                      <label className="form-label small text-muted fw-bold">{t.fixedCosts}</label>
                                      <div className="input-group">
                                        <span className="input-group-text border-end-0 text-muted">€</span>
                                        <input type="text" className="form-control border-start-0 ps-1" value={formatForInput(fixedCosts)} onChange={(e) => setFixedCosts(parseFromInput(e.target.value))} />
                                      </div>
                                    </div>
                                    <div className="col-6">
                                      <label className="form-label small text-muted fw-bold">{t.variableCosts}</label>
                                      <div className="input-group">
                                        <span className="input-group-text border-end-0 text-muted">€</span>
                                        <input type="text" className="form-control border-start-0 ps-1" value={formatForInput(variableCosts)} onChange={(e) => setVariableCosts(parseFromInput(e.target.value))} />
                                      </div>
                                    </div>
                                  </div>
                                  <div>
                                    <label className="form-label small text-muted fw-bold">{t.costGrowth}</label>
                                    <div className="input-group">
                                      <input type="number" className="form-control border-end-0" value={costGrowth || ''} onChange={(e) => setCostGrowth(parseFloat(e.target.value) || 0)} />
                                      <span className="input-group-text border-start-0 text-muted">%</span>
                                    </div>
                                    <div className="form-text small text-muted mt-1" style={{ fontSize: '0.7rem' }}>{t.costGrowthHint}</div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="border-top pt-3">
                                <button className="btn btn-link p-0 text-decoration-none fw-bold d-flex align-items-center w-100 justify-content-between mb-3" onClick={() => setShowUnitEconomics(!showUnitEconomics)}>
                                  <span className="small text-uppercase text-muted" style={{ fontSize: '0.75rem', letterSpacing: '1px' }}>{t.unitEconomics}</span>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style={{ transform: showUnitEconomics ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' }}>
                                    <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                  </svg>
                                </button>
                                {showUnitEconomics && (
                                  <div className="p-3 rounded d-flex flex-column gap-3 fade-scale" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                    <div>
                                      <label className="form-label small text-muted fw-bold">{t.unitsSold}</label>
                                      <input type="text" className="form-control" value={formatForInput(units)} onChange={(e) => {
                                        const v = parseFromInput(e.target.value);
                                        setUnits(v);
                                        setMonthlyRevenue(v * unitPrice);
                                        setVariableCosts(v * unitCost);
                                      }} />
                                    </div>
                                    <div className="row g-2">
                                      <div className="col-6">
                                        <label className="form-label small text-muted fw-bold">{t.pricePerUnit}</label>
                                        <input type="text" className="form-control" value={formatForInput(unitPrice)} onChange={(e) => {
                                          const v = parseFromInput(e.target.value);
                                          setUnitPrice(v);
                                          setMonthlyRevenue(units * v);
                                        }} />
                                      </div>
                                      <div className="col-6">
                                        <label className="form-label small text-muted fw-bold">{t.costPerUnit}</label>
                                        <input type="text" className="form-control" value={formatForInput(unitCost)} onChange={(e) => {
                                          const v = parseFromInput(e.target.value);
                                          setUnitCost(v);
                                          setVariableCosts(units * v);
                                        }} />
                                      </div>
                                    </div>
                                  </div>
                              ...
                              {/* Section: One-Time & Buffers */}
                              <div>
                                <h6 className="text-uppercase text-secondary fw-bold" style={{ fontSize: '0.75rem', letterSpacing: '1px' }}>{t.financialBuffers}</h6>
                                <div className="p-3 rounded d-flex flex-column gap-3" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                  <div className="row g-2">
                                    <div className="col-6">
                                      <label className="form-label small text-muted fw-bold">{t.oneTimeRevenue}</label>
                                      <input type="text" className="form-control" value={formatForInput(oneTimeRevenue)} onChange={(e) => setOneTimeRevenue(parseFromInput(e.target.value))} />
                                    </div>
                                    <div className="col-6">
                                      <label className="form-label small text-muted fw-bold">{t.oneTimeCost}</label>
                                      <input type="text" className="form-control" value={formatForInput(oneTimeCost)} onChange={(e) => setOneTimeCost(parseFromInput(e.target.value))} />
                                    </div>
                                  </div>
                                  <div>
                                    <label className="form-label small text-muted fw-bold">{t.taxRate}</label>
                                    <div className="input-group">
                                      <input type="number" className="form-control border-end-0" value={taxRate || ''} onChange={(e) => setTaxRate(parseFloat(e.target.value) || 0)} />
                                      <span className="input-group-text border-start-0 text-muted">%</span>
                                    </div>
                                    <div className="form-text small text-muted mt-1" style={{ fontSize: '0.7rem' }}>Estimate VAT or income tax to set aside for reliable cash forecasting.</div>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div className="card-body p-4">
                          <div className="d-flex justify-content-between align-items-center mb-4">
                            ...
                            {activeTab === 'prediction' && (
                              <div className="timeline-container" data-dir={(() => {
                                const opts = ['7d', '1m', '3m', '6m', '1y'];
                                const curr = opts.indexOf(timeline);
                                if (curr > prevTimelineIndex) return 'forward';
                                if (curr < prevTimelineIndex) return 'backward';
                                return 'none';
                              })()}>
                                <div
                                  className="timeline-slider-backdrop"
                                  style={(() => {
                                    const opts = ['7d', '1m', '3m', '6m', '1y'];
                                    const idx = opts.indexOf(timeline);
                                    const perPart = 100 / opts.length;
                                    return {
                                      left: `calc(4px + ${idx * perPart}%)`,
                                      right: `calc(4px + ${(opts.length - 1 - idx) * perPart}%)`,
                                      width: 'auto'
                                    };
                                  })()}
                                />
                                {['7d', '1m', '3m', '6m', '1y'].map((opt, i) => (
                                  <button
                                    key={opt}
                                    className={`timeline-pill ${timeline === opt ? 'active' : ''}`}
                                    onClick={() => {
                                      if (timeline === opt) return;
                                      const opts = ['7d', '1m', '3m', '6m', '1y'];
                                      setPrevTimelineIndex(opts.indexOf(timeline));
                                      setIsTimelineChanging(true);
                                      setTimeline(opt);
                                      setTimeout(() => setIsTimelineChanging(false), 500);
                                    }}
                                  >
                                    {opt}
                                  </button>
                          ...
                          {activeTab === 'prediction' && (
                            <div className={`fade-scale chart-container-animated ${isTimelineChanging ? 'chart-shifting' : ''}`}>

                              {/* Metric cards row */}
                              {(() => {
                                const loanM = loanInfo.totalPayment || 0;
                                const totalC = fixedCosts + variableCosts + loanM;
                                const netM = monthlyRevenue - totalC;
                                const marginM = monthlyRevenue > 0 ? ((monthlyRevenue - (fixedCosts + variableCosts + loanM)) / monthlyRevenue * 100).toFixed(0) : 0;
                                const runwayM = netM < 0 && cashBalance > 0 ? Math.floor(cashBalance / Math.abs(netM)) : null;
                                const lastPoint = forecastData.projection && forecastData.projection.length > 0 ? forecastData.projection[forecastData.projection.length - 1] : 0;
                                const fmt = (n) => new Intl.NumberFormat(language === 'fi' ? 'fi-FI' : 'en-US', { style: 'currency', currency: 'EUR', maximumFractionDigits: 0 }).format(n);

                                return (
                                  <div className="row g-3 mb-4">
                                    <div className="col-6 col-md-3">
                                      <div className="p-3 border rounded h-100" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                        <p className="text-secondary mb-1 small fw-bold text-uppercase">Net Cash</p>
                                        <p className={`h4 mb-0 fw-bold ${netM >= 0 ? 'text-success' : 'text-danger'}`}>
                                          {netM >= 0 ? '+' : ''}{fmt(netM)}
                                        </p>
                                      </div>
                                    </div>
                                    <div className="col-6 col-md-3">
                                      <div className="p-3 border rounded h-100" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                        <p className="text-secondary mb-1 small fw-bold text-uppercase">Margin</p>
                                        <p className={`h4 mb-0 fw-bold ${parseFloat(marginM) >= 0 ? 'text-success' : 'text-danger'}`}>
                                          {marginM}%
                                        </p>
                                      </div>
                                    </div>
                                    <div className="col-6 col-md-3">
                                      <div className="p-3 border rounded h-100" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                        <p className="text-secondary mb-1 small fw-bold text-uppercase">Runway</p>
                                        <p className={`h4 mb-0 fw-bold ${runwayM !== null ? 'text-danger' : 'text-success'}`}>
                                          {runwayM !== null ? `${runwayM} mo` : 'Profitable'}
                                        </p>
                                      </div>
                                    </div>
                                    <div className="col-6 col-md-3">
                                      <div className="p-3 border rounded h-100" style={{ backgroundColor: 'var(--highlight-bg)' }}>
                                        <p className="text-secondary mb-1 small fw-bold text-uppercase">Projected</p>
                                        <p className={`h4 mb-0 fw-bold ${lastPoint >= 0 ? 'text-primary' : 'text-danger'}`}>
                                          {fmt(lastPoint)}
                                        </p>
                                      </div>
                                    </div>
                              ...
                              <div className="d-flex justify-content-center gap-2 mt-3 mb-4">
                                ...
                                <button
                                  className={`btn btn-sm rounded-pill d-flex align-items-center gap-2 border ${showProfit ? 'bg-secondary-subtle text-secondary-emphasis border-secondary-subtle fw-bold' : 'text-muted'}`}
                                  onClick={() => setShowProfit(!showProfit)}
                                >
                                  <span className="rounded-circle" style={{ width: 10, height: 10, backgroundColor: secondaryColor, opacity: showProfit ? 1 : 0.5 }}></span>
                                  {t.monthlyProfit}
                                </button>
              ...
              <Route path="/submissions" element={<CombinedResults t={t} theme={theme} />} />
  ...
  return (
    <div className={`${theme}-theme nav-fixed`}>
      <style>{globalStyles}</style>
      <div className="app-container zoom-wrapper">
        {loginModal}
        {upgradeModal}
        {paymentSuccessModal}
        {pageContent}
